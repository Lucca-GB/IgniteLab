//essa lib nos ajuda com todas as configurações de videos necessarias
                ...
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            ...
                            src="https://github.com/Lucca-GB.png"
                            alt=""
                            />

                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Lucca GB</strong>
                                <strong className="text-gray-200 text-sm block">Full Stack Developer @2RP</strong>
                            </div>
                        </div>
                ...
                <div className="gap-8 mt-20 grid grid-cols-2">
                    <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
                        ...
                        <div className="py-6 leading-relaxed">
                            <strong className="text-2xp">Material complementar</strong>
                    ...
                    <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
                        ...
                        <div className="py-6 leading-relaxed">
                            <strong className="text-2xp">Wallpapers exclusivos</strong>
                            <p className="text-sm text-gray-200 mt-2">
